...
function openOnlineBattleHub(){
 ...
 showModal('온라인 대전',`<div class="battle-hub">
  ...
  <div class="battle-mode-grid">
   ...
   <button id="battleGostopBtn" class="battle-mode-card gostop"><span>GO-STOP</span><b>고스톱</b><small>2인 맞고 / 3인 고스톱 · 판돈 없는 점수전</small></button>
  </div>
  <p class="battle-hub-note">루미큐브 판돈은 게임 속 가상 보유금만 사용합니다. 고스톱은 판돈 없이 점수로만 승부합니다.</p>
 </div>`,'online');
